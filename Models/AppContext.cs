...
public partial class DbAnimeTitlesContext : DbContext
{
    ...
    public virtual DbSet<AnimeTitlesGenre> AnimeTitlesGenres { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AnimeTitlesGenre>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("anime_titles_genres_pkey");

            entity.ToTable("anime_titles_genres");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.IdAnime).HasColumnName("id_anime");
            entity.Property(e => e.IdGenre).HasColumnName("id_genre");

            entity.HasOne(d => d.AnimeTitle).WithMany(p => p.AnimeTitlesGenres)
                .HasForeignKey(d => d.IdAnime)
                .HasConstraintName("fk_titles_genres_to_anime_titles");

            entity.HasOne(d => d.Genre).WithMany(p => p.AnimeTitlesGenres)
        ...
        modelBuilder.Entity<Genre>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.GenresName).HasColumnName("genres_name");
        });
        ...
        modelBuilder.Entity<TitlesStatus>(entity =>
        {
            ...
            entity.HasOne(d => d.AnimeTitle).WithMany(p => p.TitlesStatuses)
                .HasForeignKey(d => d.IdAnime)
                .HasConstraintName("fk_titles_statuses_to_anime_statuses");

            entity.HasOne(d => d.Status).WithMany(p => p.TitlesStatuses)
                .HasForeignKey(d => d.IdStatus)
                .HasConstraintName("fk_titles_statuses_to_stateses");
        });
